            ...
            {socials.map((social, index) => {
              ...
              return (
                <a
                  ...
                  className="p-2.5 rounded-lg border border-(--color-border)/30 text-(--color-text) hover:bg-(--color-accent) hover:text-(--color-primary) transition-all duration-300 hover:scale-110"
